...
function DetailsPage() {
  ...
  return (
    <div>
      <div className="flex items-center gap-14 bg-[#418ace] text-white px-3 ">
        <button className="back-btn" onClick={() => navigate('/')} type="button">
          <img src={backIcon} alt="back icon" />
        </button>
      </div>
      <div className="w-screen text-white items-center">
        <div className="flex flex-col items-end justify-center bg-[#50c5fb] w-screen h-44 px-4">
        ...
        <div className="flex py-5 px-4 justify-between bg-[#418ace]">
          <p>Date and time </p>
          <p>
            {humanDateFormat}
            {' '}
        ...
        <div className="flex py-5 px-4 justify-between bg-[#50c5fb]">
